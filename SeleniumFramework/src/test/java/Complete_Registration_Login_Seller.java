...
public class Complete_Registration_Login_Seller {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 String projectPath = System.getProperty("user.dir");
	        ...
	        try {
	            ...
	            WebElement buyerRadio = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"role\"]/label[2]")));
	            buyerRadio.click();
	    ...
	    private static void saveCredentialsToFile(String email, String password) {
	        try {
	            File file = new File("credentials_Seller.txt");
	            ...
	            System.out.println("Credentials saved to credentials_Seller.txt");
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
	    }
	    ...
	    private static String[] retrieveCredentialsFromFile() {
	        ...
	        try {
	            BufferedReader reader = new BufferedReader(new FileReader("credentials_Seller.txt"));
