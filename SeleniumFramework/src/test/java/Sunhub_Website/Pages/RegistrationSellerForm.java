...
public class RegistrationSellerForm {
	 ...
	 WebDriver driver;
	    ...
	    public By sellerRadio = By.xpath("//*[@id='role']/label[2]");
	    ...
	    // Constructor
	    public RegistrationSellerForm(WebDriver driver) {
	        this.driver = driver;
	    }

	    // Actions
	    public void selectSellerRole() {
	        driver.findElement(sellerRadio).click();
	    }
