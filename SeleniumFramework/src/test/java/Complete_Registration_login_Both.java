...
public class Complete_Registration_login_Both {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 String projectPath = System.getProperty("user.dir");
	        ...
	        try {
	            ...
	            WebElement buyerRadio = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"role\"]/label[3]")));
	            buyerRadio.click();
	    ...
	    private static void saveCredentialsToFile(String email, String password) {
	        try {
	            File file = new File("credentials_both.txt");
	            ...
	            System.out.println("Credentials saved to credentials_both.txt");
	        } catch (IOException e) {
	            e.printStackTrace();
	        }
	    }
	    ...
	    private static String[] retrieveCredentialsFromFile() {
	        ...
	        try {
	            BufferedReader reader = new BufferedReader(new FileReader("credentials_both.txt"));
